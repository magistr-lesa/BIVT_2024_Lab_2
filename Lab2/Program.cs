...
public class Program
{
    ...
    public double Task_2_1(int n)
    {
        ...
        double high = 0;
        for (int i = 0; i<n; i++) {
            WriteLine("Введите рост ученика");
    ...
    public int Task_2_2(int n, double r, double a, double b)
    {
        ...
        double x,y;
        for (int h = 1; h <= n; h++) {
            WriteLine($"Введите координаты точки {h}");
    ...
    public int Task_2_4(int n, double r1, double r2)
    {
        int answer = 0;
        double x,y;
        // где центр окружности?????? предположим, он в т.(0;0)
        for (int h = 1; h <= n; h++) {
            WriteLine($"Введите координаты точки {h}");
            double.TryParse(ReadLine(), out x);
            double.TryParse(ReadLine(), out y);
    ...
    public int Task_2_6(int n)
    {
        ...
        double x,y;
        for (int d = 1; d<=n; d++) {
            WriteLine($"Введите координаты точки {d}");
            double.TryParse(ReadLine(), out x);
            double.TryParse(ReadLine(), out y);
    ...
    public (int, int) Task_2_7(int n)
    {
        ...
        for (int d = 0; d<n; d++) {
            ...
            if (x>0 && y>0) {
                ...
                WriteLine("Точка не принадлежит определенному квадранту");
                continue;
            }
            WriteLine($"Точка ({x};{y}) лежит в {kvadrant} квадранте");
        }
        WriteLine(answer1);
        WriteLine(answer3);
    ...
    public double Task_2_9(int n)
    {
        ...
        double result;
        for (int g = 1; g<=n; g++) {
            WriteLine("Введите результат игрока {g}");
            double.TryParse(ReadLine(), out result);
    ...
    public int Task_2_10(int n)
    {
        ...
        for (int a = 1; a<=n; a++) {
            WriteLine($"Введите результаты экзамена {a}-го студента");
    ...
    public double Task_3_3()
    {
        ...
        double weight;
        for (int i = 1; ;i++) {
            WriteLine($"Введите вес {i}-го ученика, чтобы закончить ввод напишите STOP");
            string input = ReadLine();
            if (input == "STOP") {
                break;
            }
    ...
    public int Task_3_6()
    {
        ...
        double x,y;
        for (int d = 1; ; d++) {
            WriteLine($"Введите координаты точки {d}, чтобы закончить ввод напишите STOP");
    ...
    public double Task_3_9()
    {
        ...
        double result;
        for (int g = 1; ; g++) {
            WriteLine($"Введите результат {g}-го игрока, чтобы закончить ввод напишите STOP");
            string input = ReadLine();
            if (input == "STOP") {
                break;
            }
